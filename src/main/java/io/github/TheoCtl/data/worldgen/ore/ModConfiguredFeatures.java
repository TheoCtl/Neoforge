package io.github.TheoCtl.data.worldgen.ore;
...
public class ModConfiguredFeatures {
    ...
    private static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(XCraft.MOD_ID, name));
    }
